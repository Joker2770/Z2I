...
Download onnxruntime: <https://github.com/microsoft/onnxruntime/releases/tag/v1.27.1>
...
or build with xmake toolchain(In this way, `onnruntime-1.27.1` will be installed with xrepo).
